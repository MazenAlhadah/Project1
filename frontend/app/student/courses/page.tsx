...
export default function StudentCoursesPage() {
  ...
  const placeholderCourses = courses.length > 0 ? courses : [
    { id: '1', title: 'رياضيات هندسية', description: 'أسس الرياضيات للمهندسين', cover_image_url: null },
    { id: '2', title: 'ميكانيكا التربة', description: 'دراسة خصائص التربة وتطبيقاتها', cover_image_url: null },
    { id: '3', title: 'تصميم الخرسانة', description: 'أسس تصميم المنشآت الخرسانية', cover_image_url: null },
  ];
      ...
      {loading ? (
        ...
        <div className="courses-grid">
          {placeholderCourses.map((course) => (
            <div key={course.id} className="course-card" style={{ cursor: 'default', opacity: 0.85 }}>
              <div style={{ position: 'relative' }}>
                ...
                <div className="coming-soon-badge">⏰ يتم الإضافة قريباً</div>
              </div>
